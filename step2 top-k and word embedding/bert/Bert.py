...
# ================= 3. 权重系数（High/Low 调整） =================
HIGH_MULTIPLIER = 1.5    # High_DF 的权重增益
...
plt.title("国家政策语义相似度（BERT + Top-K 关键词）")
plt.tight_layout()
plt.savefig(r"C:\Users\Andy\Desktop\文本分析\GCPS\step2 top-k and word embedding\bert\Task3_BERT_Heatmap.png")
